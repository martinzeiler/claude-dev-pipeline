...
4. Proveď fáze 1–7 z PIPELINE.md **inline v této session**. Subagenty spouštěj jen tam, kde to PIPELINE.md výslovně říká (`dev-pipeline:prd-check`, `dev-pipeline:code-review`, `dev-pipeline:e2e-verifier`) — implementaci a deploy dělej sám.
