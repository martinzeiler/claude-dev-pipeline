...
4. Proveď fáze 1–7 z PIPELINE.md **inline v této session**. Subagenty spouštěj jen tam, kde to PIPELINE.md výslovně říká (plan-check, e2e-verifier) — implementaci, review a deploy dělej sám.
