...
Repo je zároveň plugin marketplace pro Claude Code. Plugin je v adresáři `dev-pipeline/`, návody a šablony pro instalaci v `setup/`, analýzy skutečných běhů v `docs/`.
...
- **0.9.x (srpen až září 2026)** — pipeline řízená promptem v jedné session; rozbor v `docs/analyza-behu-sklik-2026-09.md`.
